...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->SetFont('Times', '', 12);
        $this->SetXY(10, 20);
        $this->Cell(0, 0, 'ParkVison PARKING', 0, 1, 'L'); // Cambié el último parámetro a 1

        $this->SetX(10);
        $this->Cell(0, 0, 'E72706781', 0, 1, 'L');

        $this->SetX(10);
        $this->Cell(0, 0, 'Dolores Hidalgo s/n CV-852', 0, 1, 'L');
        ...
        $this->SetX(10);
        $this->Cell(0, 0, 'DesarrolladoresUTNG@parking.com', 0, 1, 'L');
